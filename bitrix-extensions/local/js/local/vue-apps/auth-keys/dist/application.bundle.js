...
(function (exports,ui_vue3,ui_vue3_router,local_vueComponents_controlComponent,local_vueComponents_buttonComponent,local_vueComponents_modalYesNo,ui_vue3_pinia,local_vueComponents_messageComponent) {
  ...
  var Auth = {
    ...
    methods: _objectSpread(_objectSpread(_objectSpread({}, ui_vue3_pinia.mapActions(dataStore, ['setError'])), ui_vue3_pinia.mapActions(authStore, ['input', 'runSend', 'setLabels'])), {}, {
        ...
        babelHelpers.classPrivateFieldSet(this, _application, ui_vue3.BitrixVue.createApp({
          ...
          mounted: function mounted() {
            ...
            if (self.options.lang) {
              var lang = JSON.parse(self.options.lang);
              if (lang.auth) {
