...
(function (
  ...
  var Auth = {
    ...
    computed: _objectSpread(
      _objectSpread(
        {},
        ui_vue3_pinia.mapState(dataStore, ['routeWatcher', 'error'])
      ),
      ui_vue3_pinia.mapState(authStore, [
        'lang',
        'interface',
        'controls',
        'submitProps',
    ...
    methods: _objectSpread(
      _objectSpread(
        ...
        ui_vue3_pinia.mapActions(authStore, ['input', 'runSend', 'setLabels'])
      ),
      {},
      {
    ...
    methods: _objectSpread$1(
      _objectSpread$1(
        _objectSpread$1(
          ...
          ui_vue3_pinia.mapActions(authStore, ['runSend'])
        ),
  ...
  var Edit = {
    ...
    computed: _objectSpread$2(
      ...
      ui_vue3_pinia.mapState(editStore, [
        'lang',
        'controls',
        'editProps',
        'deleteProps',
    ...
    methods: _objectSpread$2(
      _objectSpread$2(
        _objectSpread$2({}, ui_vue3_pinia.mapActions(dataStore, ['setError'])),
        ui_vue3_pinia.mapActions(editStore, ['edit', 'delete'])
      ),
      {},
      {
  ...
  var Info = {
    ...
    computed: _objectSpread$3(
      ...
      ui_vue3_pinia.mapState(infoStore, ['lang'])
    ),
    watch: {
      routeWatcher: function routeWatcher(val) {
        this.$router.push(val);
