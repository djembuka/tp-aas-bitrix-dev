...
(function (exports,ui_vue3,local_vueComponents_controlChoice,local_vueComponents_buttonComponent,local_vueComponents_loaderCircle,local_vueComponents_messageComponent,ui_vue3_pinia) {
  ...
  var dataStore = ui_vue3_pinia.defineStore('data', {
    ...
    actions: {
      ...
      runBitrixMethod: function runBitrixMethod(method, data) {
        ...
        return BX.ajax.runComponentAction(this.actions[method][0], this.actions[method][1], {
          mode: 'class',
          data: _objectSpread(_objectSpread({}, this.customData), data),
  ...
  var Application = {
    ...
    computed: _objectSpread$1(_objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'id', 'loading', 'error', 'votingDetailURL', 'voting'])), ui_vue3_pinia.mapState(controlsStore, ['blocks'])), {}, {
      ...
      isDisabled: function isDisabled() {
        return this.blocks.some(function (b) {
          return b.controls.some(function (c) {
    ...
    methods: _objectSpread$1(_objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapActions(dataStore, ['runBitrixMethod', 'changeProp'])), ui_vue3_pinia.mapActions(controlsStore, ['changeBlocks', 'changeControlValue', 'runHints', 'setHints'])), {}, {
      ...
      formatToSqlDatetime: function formatToSqlDatetime(input) {
        if (typeof input !== 'string') return input;
        var _input$trim$split = input.trim().split(/\s+/),
          _input$trim$split2 = babelHelpers.slicedToArray(_input$trim$split, 2),
          datePart = _input$trim$split2[0],
          timePartRaw = _input$trim$split2[1];
        if (!datePart) return input;
        var m = datePart.match(/^(\d{2})\.(\d{2})\.(\d{4})$/);
        if (!m) return input;
        var _m = babelHelpers.slicedToArray(m, 4),
          dd = _m[1],
          mm = _m[2],
          yyyy = _m[3];
        ...
        if (timePartRaw) {
          var _t$;
          var t = timePartRaw.match(/^(\d{1,2}):(\d{1,2})(?::(\d{1,2}))?$/);
          if (!t) return null;
          hh = String(t[1]).padStart(2, '0');
          min = String(t[2]).padStart(2, '0');
          ss = String((_t$ = t[3]) !== null && _t$ !== void 0 ? _t$ : '00').padStart(2, '0');
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (document.querySelector('#PollCreateApp')) {
                document.querySelector('#PollCreateApp').addEventListener('closeModal', function () {
              ...
              if (_this2.voting.uuid) {
                ...
                votingArray.forEach(function (item) {
                  _this2.changeControlValue({
                    ...
                    value: String(_this2.voting[item[2]])
                  });
                });
              }
            case 2:
  ...
  var VotingCreate = /*#__PURE__*/function () {
    function VotingCreate(rootNode, options) {
      babelHelpers.classCallCheck(this, VotingCreate);
    ...
    babelHelpers.createClass(VotingCreate, [{
      key: "run",
      value: function run() {
        var self = this;
