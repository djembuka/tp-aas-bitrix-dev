...
(function (exports,ui_vue3,ui_vue3_router,local_vueComponents_controlComponent,local_vueComponents_buttonComponent,ui_vue3_pinia) {
  ...
  var FormControlsComponent = {
    ...
    methods: _objectSpread(_objectSpread({}, ui_vue3_pinia.mapActions(formControlsStore, ['changeControlValue', 'runHints', 'setHints', 'addTab'])), {}, {
  ...
  var ButtonsComponent = {
    ...
    computed: _objectSpread$1({}, ui_vue3_pinia.mapState(buttonsStore, ['buttons'])),
    methods: {
