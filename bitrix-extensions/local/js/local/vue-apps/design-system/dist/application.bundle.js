...
(function (
  ...
  local_vueComponents_modalYesNo,
  local_vueComponents_modalAnyContent,
  local_vueComponents_buttonComponent,
  local_vueComponents_docComponent,
  local_vueComponents_loaderCircle,
  local_vueComponents_loaderBubbles,
  local_vueComponents_loaderSquares,
  ui_vue3_pinia
) {
  'use strict';
  ...
  var selectDependencyStore = ui_vue3_pinia.defineStore(
    'select-dependency-store',
    {
      state: function state() {
        return {
          controls: [
  ...
  var SelectDependencyComponent = {
    ...
    computed: _objectSpread$1(
      {},
      ui_vue3_pinia.mapState(selectDependencyStore, ['controls'])
    ),
    methods: _objectSpread$1(
      _objectSpread$1(
        {},
        ui_vue3_pinia.mapActions(selectDependencyStore, ['changeControlValue'])
      ),
      {},
      {
        input: function input(_ref) {
  ...
  var ModalsComponent = {
    ...
    computed: _objectSpread$5(
      {},
      ui_vue3_pinia.mapState(modalsStore, ['modal_yes_no', 'modal_any_content'])
    ),
    methods: {
  ...
  var LoadersComponent = {
    ...
    computed: _objectSpread$7(
      {},
      ui_vue3_pinia.mapState(loadersStore, ['loaders'])
    ),
    methods: {
