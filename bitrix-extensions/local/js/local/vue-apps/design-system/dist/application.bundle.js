...
(function (exports,ui_vue3,ui_vue3_router,local_vueComponents_controlComponent,local_vueComponents_controlChoice,local_vueComponents_buttonComponent,ui_vue3_pinia) {
    ...
    state: function state() {
      return {
        controls: [{
          ...
          required: false,
          disabled: false
        }, "multi", 3), babelHelpers.defineProperty({
          id: 'id1-1',
          property: 'textarea',
          name: 'MESSAGE',
          label: 'Message',
  ...
  var FormControlsMultiComponent = {
    ...
    computed: _objectSpread$2({}, ui_vue3_pinia.mapState(formControlsMultiStore, ['controls'])),
    methods: _objectSpread$2(_objectSpread$2({}, ui_vue3_pinia.mapActions(formControlsMultiStore, ['changeControlValue', 'runHints', 'setHints', 'createMulti', 'addMulti', 'removeMulti'])), {}, {
  ...
  var ButtonsComponent = {
    ...
    computed: _objectSpread$3({}, ui_vue3_pinia.mapState(buttonsStore, ['buttons'])),
    methods: {
