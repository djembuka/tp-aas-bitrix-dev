/* eslint-disable */
(function (exports,ui_vue3,local_vueComponents_modalYesNo,local_vueComponents_docComponent,local_vueComponents_controlChoice,local_vueComponents_buttonComponent,local_vueComponents_loaderCircle,local_vueComponents_messageComponent,local_vueComponents_modalAnyContent,ui_vue3_pinia) {
  'use strict';
  ...
  var GroupsComponent = {
    ...
    computed: _objectSpread$2(_objectSpread$2(_objectSpread$2(_objectSpread$2({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'uuid', 'typeMode', 'actionMode', 'groups', 'questions', 'answers', 'deleteModalStateWatcher', 'itemToDelete'])), ui_vue3_pinia.mapState(controlsStore, ['questionFormBlocks'])), ui_vue3_pinia.mapState(addEditStore, ['addEditStateWatcher'])), {}, {
      currentLang: function currentLang() {
        return this.lang.deleteModal[this.typeMode];
      }
    }),
    methods: _objectSpread$2(_objectSpread$2(_objectSpread$2(_objectSpread$2({}, ui_vue3_pinia.mapActions(dataStore, ['runBitrixMethod', 'changeProp', 'pushItemsArray'])), ui_vue3_pinia.mapActions(controlsStore, ['fillGroupForm', 'fillQuestionForm', 'fillAnswerForm', 'changeControlValue'])), ui_vue3_pinia.mapActions(addEditStore, ['addEditChangeProp'])), {}, {
      ...
      clickDeleteModalYes: function clickDeleteModalYes() {
        ...
        return babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee() {
          ...
          return _regeneratorRuntime$1().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                item = _objectSpread$2({}, _this.itemToDelete);
                _context.prev = 1;
  ...
  var AddEditForm = {
    ...
    computed: _objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3({}, ui_vue3_pinia.mapState(dataStore, ['uuid', 'groupUuid', 'questionUuid', 'typeMode', 'actionMode', 'groups', 'questions', 'answers'])), ui_vue3_pinia.mapState(addEditStore, ['lang', 'addEditStateWatcher', 'addEditLoading', 'addEditError', 'image'])), ui_vue3_pinia.mapState(controlsStore, ['groupFormBlocks', 'questionFormBlocks', 'answerFormBlocks', 'createMulti', 'addMulti', 'removeMulti'])), {}, {
      currentLang: function currentLang() {
    ...
    methods: _objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3({}, ui_vue3_pinia.mapActions(dataStore, ['runBitrixMethod', 'changeProp', 'pushItemsArray'])), ui_vue3_pinia.mapActions(controlsStore, ['changeControlValue', 'changeGroupFormBlocks', 'changeQuestionFormBlocks', 'fillGroupForm', 'fillQuestionForm', 'fillAnswerForm', 'runHints', 'setHints'])), ui_vue3_pinia.mapActions(addEditStore, ['addEditChangeProp'])), {}, {
      ...
      createQuestionFormData: function createQuestionFormData() {
        ...
        var data = {
          ...
          files: this.questionFormBlocks[1].controls[0].multi.map(function (c) {
            return c.file;
          }),
          ...
          if (value !== undefined && value !== null) {
            if (Array.isArray(value)) {
              value.forEach(function (v, i) {
                if (v) {
                  formData.append("".concat(key, "[").concat(i, "]"), v);
                }
              });
            } else {
              formData.append(key, value);
  ...
  var Application = {
    ...
    computed: _objectSpread$4(_objectSpread$4({}, ui_vue3_pinia.mapState(dataStore, ['customData', 'signedParameters', 'lang', 'uuid', 'loading', 'error', 'typeMode', 'actionMode', 'voting', 'groups', 'questions', 'answers', 'modalStateWatcher', 'modalLoading', 'modalError', 'editModalStateWatcher', 'editModalLoading', 'editModalError'])), {}, {
    ...
    methods: _objectSpread$4(_objectSpread$4(_objectSpread$4({}, ui_vue3_pinia.mapActions(dataStore, ['runBitrixMethod', 'changeProp', 'pushItemsArray'])), ui_vue3_pinia.mapActions(controlsStore, ['changeGroupFormBlocks', 'changeQuestionFormBlocks', 'changeControlValue', 'clearGroupForm', 'clearQuestionForm', 'runHints', 'setHints'])), {}, {
...
}((this.BX = this.BX || {}),BX,BX.Modals,BX.AAS,BX.Controls,BX.AAS,BX.Loaders,BX.AAS,BX.Modals,BX));
