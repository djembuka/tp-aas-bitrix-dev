...
(function (exports,ui_vue3,local_vueComponents_filter,local_vueComponents_table,local_vueComponents_pagination,local_vueComponents_loaderCircle,local_vueComponents_errorMessage,ui_vue3_pinia) {
  ...
  var Application = {
    ...
    methods: _objectSpread(_objectSpread(_objectSpread({}, ui_vue3_pinia.mapActions(tableStore, ['hideErrorTable', 'runColumnsNames', 'runItems', 'runDefaultSort', 'runSetDefaultSort'])), ui_vue3_pinia.mapActions(filterStore, ['hideErrorFilter', 'runFilters', 'changeControlValue', 'runHintsAction'])), {}, {
...
}((this.BX = this.BX || {}),BX,BX.AAS,BX.AAS,BX.AAS,BX.Loaders,BX.AAS,BX));
