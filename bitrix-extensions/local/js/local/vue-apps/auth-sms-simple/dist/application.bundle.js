...
(function (exports,ui_vue3,ui_vue3_router,local_vueComponents_controlComponent,ui_vue3_pinia,local_vueComponents_messageComponent,local_vueComponents_buttonComponent) {
        ...
        if (window.BX) {
          BX.ajax.runComponentAction('twinpx:profile.edit', 'add', {
            ...
            if (String(response.errors[0].code) === String(1001)) {
              ...
              _this4.controls[0].regexp_description = response.errors[0].message || '';
  ...
  var Sms = {
    ...
    computed: _objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'state'])), ui_vue3_pinia.mapState(smsStore, ['controls', 'submitProps', 'deleteProps', 'buttonDisabled', 'buttonSubmitTimerText', 'telIsFilled'])),
    watch: {
    ...
    methods: _objectSpread$1(_objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapActions(dataStore, ['setError', 'setQuery'])), ui_vue3_pinia.mapActions(smsStore, ['input', 'runSend', 'runUpdate', 'runDelete', 'changeTel', 'setTelIsFilled'])), {}, {
  ...
  var Code = {
    ...
    computed: _objectSpread$2(_objectSpread$2(_objectSpread$2({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'state', 'error'])), ui_vue3_pinia.mapState(codeStore, ['inputs', 'uuid', 'submitProps', 'buttonDisabled', 'buttonTimerText', 'timerDisabled', 'timerProps', 'timer', 'clearInputs', 'invalidInputs'])), {}, {
      inputValue0: {
        get: function get() {
          var index = 0;
  ...
  var TwoCols = {
    ...
    computed: _objectSpread$4(_objectSpread$4(_objectSpread$4(_objectSpread$4({}, ui_vue3_pinia.mapState(dataStore, ['sessid', 'signedParameters', 'heading', 'text', 'lang', 'info', 'infoButton', 'state', 'error', 'errorButton'])), ui_vue3_pinia.mapState(smsStore, ['errorButton'])), ui_vue3_pinia.mapState(codeStore, ['uuid'])), {}, {
      altButton: function altButton() {
        return this.lang["AUTH_SMS_".concat(String(this.state).toUpperCase(), "_ALT_BUTTON")];
      }
    }),
