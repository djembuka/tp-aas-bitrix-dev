...
(function (exports,ui_vue3,ui_vue3_router,local_vueComponents_controlComponent,ui_vue3_pinia,local_vueComponents_messageComponent,local_vueComponents_buttonComponent) {
  ...
  var Sms = {
    ...
    computed: _objectSpread(_objectSpread({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'state'])), ui_vue3_pinia.mapState(smsStore, ['interface', 'controls', 'submitProps', 'deleteProps', 'buttonDisabled', 'buttonSubmitTimerText', 'telIsFilled'])),
    watch: {
    ...
    methods: _objectSpread(_objectSpread(_objectSpread({}, ui_vue3_pinia.mapActions(dataStore, ['setError'])), ui_vue3_pinia.mapActions(smsStore, ['input', 'runSend', 'runUpdate', 'runDelete', 'changeTel', 'setTelIsFilled', 'changeInterface'])), {}, {
  ...
  var Code = {
    ...
    methods: _objectSpread$1(_objectSpread$1(_objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapActions(dataStore, ['setInfoButton', 'setError'])), ui_vue3_pinia.mapActions(smsStore, ['runSend'])), ui_vue3_pinia.mapActions(codeStore, ['invertClearInputs', 'changeInputValue', 'runCheck', 'changeButtonProps', 'buttonTimer', 'setInvalidInputs'])), {}, {
  ...
  var Application = {
    ...
    computed: _objectSpread$2(_objectSpread$2(_objectSpread$2(_objectSpread$2({}, ui_vue3_pinia.mapState(dataStore, ['sessid', 'signedParameters', 'lang', 'info', 'state', 'error', 'errorButton'])), ui_vue3_pinia.mapState(smsStore, ['errorButton'])), ui_vue3_pinia.mapState(codeStore, ['uuid'])), {}, {
    ...
    methods: _objectSpread$2({}, ui_vue3_pinia.mapActions(dataStore, ['changeState', 'setInfo'])),
    mounted: function mounted() {}
  };
  ...
  var TwoCols = {
    ...
    computed: _objectSpread$3(_objectSpread$3(_objectSpread$3(_objectSpread$3({}, ui_vue3_pinia.mapState(dataStore, ['sessid', 'signedParameters', 'heading', 'text', 'lang', 'info', 'infoButton', 'state', 'error', 'errorButton'])), ui_vue3_pinia.mapState(smsStore, ['errorButton'])), ui_vue3_pinia.mapState(codeStore, ['uuid'])), {}, {
      altButton: function altButton() {
        return this.lang["AUTH_SMS_".concat(String(this.state).toUpperCase(), "_ALT_BUTTON")];
      }
    }),
    methods: _objectSpread$3(_objectSpread$3({}, ui_vue3_pinia.mapActions(dataStore, ['changeState', 'setInfo', 'setInfoMessage'])), {}, {
