...
(function (exports, ui_vue3, local_vueComponents_controlChoice, ui_vue3_pinia) {
  ...
  var formStore = ui_vue3_pinia.defineStore('form', {
    ...
    actions: {
      ...
      uploadFile: function uploadFile(_ref4) {
        return babelHelpers.asyncToGenerator(
          /*#__PURE__*/ _regeneratorRuntime().mark(function _callee() {
            var formData, url, xhr;
    ...
    methods: _objectSpread$1(
      ...
      {},
      {
        input: function input(args) {
          if (
            args.control.property === 'file' &&
            args.control.type === 'load'
          ) {
            this.bitrixLogs(
              11,
              ''.concat(args.control.label, ': ').concat(args.label)
            );
          }
