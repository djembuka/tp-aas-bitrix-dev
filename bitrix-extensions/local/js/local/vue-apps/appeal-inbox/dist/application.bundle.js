/* eslint-disable */
(function (exports,ui_vue3,local_vueComponents_profileChoice,local_vueComponents_predefinedFilters,local_vueComponents_filterComponent,local_vueComponents_tableComponent,local_vueComponents_stickyScroll,local_vueComponents_paginationComponent,local_vueComponents_messageComponent,ui_vue3_pinia) {
  'use strict';
            ...
            if (error.errors[0].code === 'NETWORK_ERROR') {
              if (error.data && error.data.ajaxRejectData) {
                if (error.data.ajaxRejectData.data) {
                  this.errorProfile = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ". ").concat(this.localize.APPEAL_INBOX_ERROR_CODE, ": ").concat(error.data.ajaxRejectData.data, ". ").concat(this.localize.APPEAL_INBOX_ERROR_DESCRIPTION, ": ").concat(window.BX.message('ERROR_' + error.data.ajaxRejectData.data) || window.BX.message('ERROR_SERVER'), ".");
                }
              } else if (window.BX.message) {
                this.errorProfile = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ". ").concat(this.localize.APPEAL_INBOX_ERROR_CODE, ": NETWORK_ERROR. ").concat(this.localize.APPEAL_INBOX_ERROR_DESCRIPTION, ": ").concat(window.BX.message('ERROR_OFFLINE'), ".");
              }
            } else {
              this.errorProfile = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ".").concat(error.errors[0].code ? ' ' + this.localize.APPEAL_INBOX_ERROR_CODE + ': ' + error.errors[0].code + '.' : '', " ").concat(error.errors[0].message ? ' ' + this.localize.APPEAL_INBOX_ERROR_DESCRIPTION + ': ' + error.errors[0].message + '.' : '');
            }
          }
        }
      },
        ...
        if (typeof error === 'boolean') {
          ...
          if (error.errors && babelHelpers["typeof"](error.errors) === 'object' && error.errors[0] && error.errors[0].code !== undefined) {
            if (error.errors[0].code === 'NETWORK_ERROR') {
              if (error.data && error.data.ajaxRejectData) {
                if (error.data.ajaxRejectData.data) {
                  this.errorPredefined = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ". ").concat(this.localize.APPEAL_INBOX_ERROR_CODE, ": ").concat(error.data.ajaxRejectData.data, ". ").concat(this.localize.APPEAL_INBOX_ERROR_DESCRIPTION, ": ").concat(window.BX.message('ERROR_' + error.data.ajaxRejectData.data) || window.BX.message('ERROR_SERVER'), ".");
                }
              } else if (window.BX.message) {
                this.errorPredefined = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ". ").concat(this.localize.APPEAL_INBOX_ERROR_CODE, ": NETWORK_ERROR. ").concat(this.localize.APPEAL_INBOX_ERROR_DESCRIPTION, ": ").concat(window.BX.message('ERROR_OFFLINE'), ".");
              }
            } else {
              this.errorPredefined = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ".").concat(error.errors[0].code ? ' ' + this.localize.APPEAL_INBOX_ERROR_CODE + ': ' + error.errors[0].code + '.' : '', " ").concat(error.errors[0].message ? ' ' + this.localize.APPEAL_INBOX_ERROR_DESCRIPTION + ': ' + error.errors[0].message + '.' : '');
            }
          }
        }
      },
  ...
  var tableStore = ui_vue3_pinia.defineStore('table', {
    ...
    actions: {
        ...
        if (typeof error === 'boolean') {
          ...
          if (error.errors && babelHelpers["typeof"](error.errors) === 'object' && error.errors[0] && error.errors[0].code !== undefined) {
            if (error.errors[0].code === 'NETWORK_ERROR') {
              if (error.data && error.data.ajaxRejectData) {
                if (error.data.ajaxRejectData.data) {
                  this.errorTable = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ". ").concat(this.localize.APPEAL_INBOX_ERROR_CODE, ": ").concat(error.data.ajaxRejectData.data, ". ").concat(this.localize.APPEAL_INBOX_ERROR_DESCRIPTION, ": ").concat(window.BX.message('ERROR_' + error.data.ajaxRejectData.data) || window.BX.message('ERROR_SERVER'), ".");
                }
              } else if (window.BX.message) {
                this.errorTable = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ". ").concat(this.localize.APPEAL_INBOX_ERROR_CODE, ": NETWORK_ERROR. ").concat(this.localize.APPEAL_INBOX_ERROR_DESCRIPTION, ": ").concat(window.BX.message('ERROR_OFFLINE'), ".");
              }
            } else {
              this.errorTable = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ".").concat(error.errors[0].code ? ' ' + this.localize.APPEAL_INBOX_ERROR_CODE + ': ' + error.errors[0].code + '.' : '', " ").concat(error.errors[0].message ? ' ' + this.localize.APPEAL_INBOX_ERROR_DESCRIPTION + ': ' + error.errors[0].message + '.' : '');
            }
          }
        }
      },
      ...
      runAppeals: function runAppeals(data, callback, counter) {
        var _this2 = this;
        this.loadingAppeals = true;
        var a = window.BX.ajax.runComponentAction(this.actions.appeals.component, this.actions.appeals.method, data);
        var state = this;
        ...
        if (typeof error === 'boolean') {
          ...
          if (error.errors && babelHelpers["typeof"](error.errors) === 'object' && error.errors[0] && error.errors[0].code !== undefined) {
            if (error.errors[0].code === 'NETWORK_ERROR') {
              if (error.data && error.data.ajaxRejectData) {
                if (error.data.ajaxRejectData.data) {
                  this.errorFilter = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ". ").concat(this.localize.APPEAL_INBOX_ERROR_CODE, ": ").concat(error.data.ajaxRejectData.data, ". ").concat(this.localize.APPEAL_INBOX_ERROR_DESCRIPTION, ": ").concat(window.BX.message('ERROR_' + error.data.ajaxRejectData.data) || window.BX.message('ERROR_SERVER'), ".");
                }
              } else if (window.BX.message) {
                this.errorFilter = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ". ").concat(this.localize.APPEAL_INBOX_ERROR_CODE, ": NETWORK_ERROR. ").concat(this.localize.APPEAL_INBOX_ERROR_DESCRIPTION, ": ").concat(window.BX.message('ERROR_OFFLINE'), ".");
              }
            } else {
              this.errorFilter = "".concat(this.localize.APPEAL_INBOX_ERROR_METHOD, ": ").concat(method, ".").concat(error.errors[0].code ? ' ' + this.localize.APPEAL_INBOX_ERROR_CODE + ': ' + error.errors[0].code + '.' : '', " ").concat(error.errors[0].message ? ' ' + this.localize.APPEAL_INBOX_ERROR_DESCRIPTION + ': ' + error.errors[0].message + '.' : '');
            }
          }
        }
      },
  ...
  var Application = {
    ...
    computed: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, ui_vue3_pinia.mapState(dataStore, ['userid', 'sessid', 'signedParameters'])), ui_vue3_pinia.mapState(profileStore, ['profiles', 'defaultProfile', 'profilesCounter', 'loadingProfiles', 'errorProfile'])), ui_vue3_pinia.mapState(predefinedStore, ['predefined', 'predefinedActive', 'loadingPredefined', 'loadingSelected', 'errorPredefined'])), ui_vue3_pinia.mapState(tableStore, ['loadingTable', 'columnsNames', 'appeals', 'sort', 'tableCols', 'maxCountPerRequest', 'errorTable'])), ui_vue3_pinia.mapState(filterStore, ['loadingFilter', 'filters', 'filterCols', 'errorFilter'])), {}, {
      ...
      error: function error() {
        return this.errorProfile || this.errorPredefined || this.errorFilter || this.errorTable;
      },
      selected: function selected() {
        ...
        if (this.filters) {
          filtersSelected = this.filters.find(function (f) {
            if (f.property === 'select' && babelHelpers["typeof"](f.value) === 'object') {
              return f.value.code;
            } else {
              return f.value;
            }
    ...
    methods: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, ui_vue3_pinia.mapActions(profileStore, ['runProfiles', 'runSetDefaultProfile', 'setDefaultProfile', 'increaseProfilesCounter'])), ui_vue3_pinia.mapActions(predefinedStore, ['runPredefinedFilters', 'setPredefinedActive', 'runExportFile'])), {}, {
      clickProfile: function clickProfile(_ref) {
        ...
        new Promise(function (resolve) {
          resolve(_this.runSetDefaultProfile({
            mode: 'class',
            data: {
          ...
          }, function () {}, _this.profilesCounter));
    ...
    }, ui_vue3_pinia.mapActions(tableStore, ['hideErrorTable', 'runColumnsNames', 'runAppeals', 'runDefaultSort', 'runSetDefaultSort', 'increaseAppealsCounter'])), ui_vue3_pinia.mapActions(filterStore, ['runFilters', 'changeControlValue', 'runHintsAction', 'setHints'])), {}, {
