...
(function (exports,ui_vue3,local_vueComponents_profileChoice,local_vueComponents_predefinedFilters,local_vueComponents_filterComponent,local_vueComponents_tableComponent,local_vueComponents_stickyScroll,local_vueComponents_paginationComponent,local_vueComponents_errorMessage,ui_vue3_pinia) {
  ...
  var Application = {
    ...
    computed: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, ui_vue3_pinia.mapState(dataStore, ['userid', 'sessid', 'signedParameters'])), ui_vue3_pinia.mapState(profileStore, ['profiles', 'defaultProfile', 'profilesCounter', 'loadingProfiles', 'errorProfile'])), ui_vue3_pinia.mapState(predefinedStore, ['predefined', 'predefinedActive', 'loadingPredefined', 'loadingSelected'])), ui_vue3_pinia.mapState(tableStore, ['loadingTable', 'columnsNames', 'appeals', 'sort', 'tableCols', 'maxCountPerRequest', 'errorTable'])), ui_vue3_pinia.mapState(filterStore, ['loadingFilter', 'filters', 'filterCols', 'errorFilter'])), {}, {
    ...
    methods: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, ui_vue3_pinia.mapActions(profileStore, ['runProfiles', 'runSetDefaultProfile', 'setDefaultProfile', 'increaseProfilesCounter'])), ui_vue3_pinia.mapActions(predefinedStore, ['runPredefinedFilters', 'setPredefinedActive', 'runExportFile'])), {}, {
