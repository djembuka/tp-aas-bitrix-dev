...
(function (exports,ui_vue3,local_vueComponents_controlChoice,local_vueComponents_buttonComponent,local_vueComponents_loaderCircle,local_vueComponents_messageComponent,local_vueComponents_modalYesNo,ui_vue3_pinia) {
  ...
  var formStore = ui_vue3_pinia.defineStore('form', {
    ...
    actions: {
      ...
      sendForm: function sendForm() {
        document.querySelector("#id".concat(dataStore().id, " form")).submit();
      },
      runGetForm: function runGetForm() {
        ...
        this.loading = true;
        var d = dataStore();
        var formElem = document.querySelector("#id".concat(dataStore().id, " form"));
  ...
  var Application = {
    ...
    computed: _objectSpread(_objectSpread({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'id'])), ui_vue3_pinia.mapState(formStore, ['loading', 'error', 'blocks', 'runHints', 'setHints', 'stateWatcher'])),
    methods: _objectSpread(_objectSpread({}, ui_vue3_pinia.mapActions(formStore, ['runGetForm', 'changeControlValue', 'changeStateWatcher', 'sendForm'])), {}, {
