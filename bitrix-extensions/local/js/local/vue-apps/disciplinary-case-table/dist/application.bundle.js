  ...
  var tableStore = ui_vue3_pinia.defineStore('table', {
    ...
    actions: {
            ...
            function (result) {
              ...
              if (result.data) {
                ...
                if (_this2.showButtons) {
                  ...
                  (_this2$items = _this2.items) === null ||
                  _this2$items === void 0
                    ? void 0
                    : (_this2$items$items = _this2$items.items) === null ||
                      _this2$items$items === void 0
                    ? void 0
                    : _this2$items$items.forEach(function (i) {
                        i.buttons = [
                          {
                            code: 'edit',
                            text:
      ...
      runDelete: function runDelete() {
        ...
        window.BX.ajax
          .runComponentAction(
            this.ajax.deleteItem[0],
            this.ajax.deleteItem[1],
            {
              mode: 'class',
              data: _objectSpread(
    ...
    methods: _objectSpread$1(
      ...
      {},
      {
        ...
        clickAddButton: function clickAddButton() {
          if (
            this.outerMethods.addForm &&
            window[this.outerMethods.addForm[0]]
          ) {
          ...
          babelHelpers.classPrivateFieldSet(
            ...
            ui_vue3.BitrixVue.createApp({
              ...
              beforeMount: function beforeMount() {
                ...
                tableStore().showButtons =
                  (_self$options$showBut = self.options.showButtons) !== null &&
                  _self$options$showBut !== void 0
                    ? _self$options$showBut
                    : true;
              },
            })
          );
