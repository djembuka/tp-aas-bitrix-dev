...
(function (
  ...
  var Ornz = {
    ...
    computed: _objectSpread$2(
      _objectSpread$2(
        {},
        ui_vue3_pinia.mapState(dataStore, ['lang', 'infoMessage'])
      ),
  ...
  var Restore = {
    ...
    computed: _objectSpread$6(
      _objectSpread$6({}, ui_vue3_pinia.mapState(dataStore, ['lang'])),
  ...
  var CenterCol = {
    ...
    methods: _objectSpread$7(
      _objectSpread$7({}, ui_vue3_pinia.mapActions(dataStore, ['setInfo'])),
      {},
      {
        clickInfoButton: function clickInfoButton() {
          this.setInfo('');
  ...
  var RestoreInfo = {
    ...
    computed: _objectSpread$8(
      _objectSpread$8({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'info'])),
  ...
  var ChangePassword = {
    ...
    computed: _objectSpread$9(
      _objectSpread$9({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'error'])),
