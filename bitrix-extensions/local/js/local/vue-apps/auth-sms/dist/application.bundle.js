/* eslint-disable */
(function (exports,ui_vue3,ui_vue3_router,ui_vue3_pinia,local_vueComponents_controlComponent,local_vueComponents_buttonComponent,local_vueComponents_messageComponent) {
  'use strict';
      ...
      runSend: function runSend() {
        ...
        if (window.BX) {
          BX.ajax.runAction('twinpx:authorization.api.send', {
            ...
            _this3.$router.push('/two-cols/code');
  ...
  var Ornz = {
    ...
    methods: _objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapActions(ornzStore, ['input', 'runOrnz'])), {}, {
  ...
  var Restore = {
    ...
    computed: _objectSpread$5(_objectSpread$5({}, ui_vue3_pinia.mapState(dataStore, ['lang'])), ui_vue3_pinia.mapState(restoreStore, ['controls', 'submitProps', 'buttonDisabled', 'input'])),
    methods: _objectSpread$5({}, ui_vue3_pinia.mapActions(restoreStore, ['runRestore']))
  };
  ...
  var CenterCol = {
    ...
    computed: _objectSpread$6(_objectSpread$6(_objectSpread$6({}, ui_vue3_pinia.mapState(dataStore, ['lang'])), ui_vue3_pinia.mapState(restoreStore, ['info'])), {}, {
      title: function title() {
...
}((this.BX = this.BX || {}),BX,BX,BX,BX.Controls,BX.AAS,BX.AAS));
