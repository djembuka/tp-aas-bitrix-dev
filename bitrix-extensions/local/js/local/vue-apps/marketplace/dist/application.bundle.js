...
(function (
  ...
  local_vueComponents_moreButton,
      ...
      runApiMethod: function runApiMethod() {
        ...
        return BX.ajax.runComponentAction(
          ...
          this.actions[method][1],
          {
            ...
            data:
              formData ||
              _objectSpread(_objectSpread({}, this.customData), data),
  ...
  var TheNavigation = {
    ...
    computed: {
      currentIndex: function currentIndex() {
        var _this = this;
        var index =
          this.groups.findIndex(function (s) {
                  ...
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 14:
                      ...
                      if (result.status === 'success' && result.data) {
                        ...
                        _this.error =
                          (_result$errors$ = result.errors[0]) === null ||
                          _result$errors$ === void 0
                            ? void 0
                            : _result$errors$.message;
                      } else {
  ...
  var Step = {
    ...
    computed: _objectSpread$2(
      _objectSpread$2(
        ...
        ui_vue3_pinia.mapState(applicationStore, [
          'applicationControls',
          'applicationGroups',
        ])
      ),
      {},
      {
        step: function step() {
          var groupId =
            ...
            (this.applicationGroups.length
              ? this.applicationGroups[0].id
              : undefined);
      ...
      _objectSpread$2(
        _objectSpread$2(
          _objectSpread$2(
            ...
            ui_vue3_pinia.mapActions(applicationStore, [
              'changeApplicationControls',
              'changeApplicationGroups',
            ])
          ),
          ui_vue3_pinia.mapActions(controlsStore, [
            'changeControlValue',
            'runHintsAction',
            'setHints',
          ])
        ),
        ui_vue3_pinia.mapActions(resultStore, [
          'setFormTemplate',
          'setFormDataArray',
        ])
      ),
          ...
          if (response && response.errors.length) {
            this.changeError(
              ''
                ...
                .concat(response.errors[0].message)
            );
          }
        },
        send: function send() {
  ...
  var ResultItemComponent = {
    ...
    computed: _objectSpread$3(
      _objectSpread$3(
        _objectSpread$3({}, ui_vue3_pinia.mapState(dataStore, ['lang'])),
        ui_vue3_pinia.mapState(resultStore, ['formTemplate', 'formData'])
      ),
      {},
      {
        ...
        companyDescription: function companyDescription() {
          ...
          })) === null || _this$company$data$fi === void 0
            ? void 0
            : _this$company$data$fi.value;
        },
      }
    ),
    methods: {
  ...
  var GroupApplicationComponent = {
    ...
    computed: _objectSpread$4(
      _objectSpread$4({}, ui_vue3_pinia.mapState(dataStore, ['lang'])),
      {},
      {
        num: function num() {
    ...
    methods: {
      ...
      pluralizeOrganization: function pluralizeOrganization(n) {
        var forms =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
            : this.lang.result.groupApplicationCompany;
        var abs = Math.abs(n);
        var mod10 = abs % 10;
        var mod100 = abs % 100;
  ...
  var Result = {
    ...
    computed: _objectSpread$5(
      _objectSpread$5(
        _objectSpread$5(
          {},
          ui_vue3_pinia.mapState(dataStore, ['lang', 'error', 'loading'])
        ),
        ui_vue3_pinia.mapState(resultStore, [
          'formIdArray',
          'formDataArray',
    ...
    methods: _objectSpread$5(
      ...
      {},
      {
        ...
        loadNextPage: function loadNextPage() {
          ...
          try {
            var requestArr = this.formIdArray
            ...
            Promise.all(requestArr).then(
              function (formDataArray) {
                _this.setFormDataArray(
                  formDataArray.map(function (r, i) {
                    return {
                ...
                _this.setStartIndex(
                  _this.startIndex + _this.maxCountPerRequest
                );
              },
              function (r) {
                ...
                if (r && r.errors.length) {
                  _this.changeError(
                    'searchForms - '.concat(response.errors[0].message)
                  );
                }
              }
            );
          ...
          babelHelpers.classPrivateFieldSet(
            ...
            ui_vue3.BitrixVue.createApp({
              ...
              beforeMount: function beforeMount() {
                ...
                resultStore().maxCountPerRequest =
                  self.options.maxCountPerRequest || 3;
              },
            })
          );
          babelHelpers
