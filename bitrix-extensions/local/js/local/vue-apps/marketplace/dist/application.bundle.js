...
(function (exports,ui_vue3,ui_vue3_router,local_vueComponents_messageComponent,local_vueComponents_loaderCircle,local_vueComponents_moreButton,local_vueComponents_modalAnyContent,local_vueComponents_controlComponent,local_vueComponents_buttonComponent,ui_vue3_pinia) {
    ...
    actions: {
      ...
      createUrl: function createUrl(controls) {
        ...
        controls.forEach(function (c) {
          ...
          if (c.property === 'hint') {
            var _c$value;
            value = (_c$value = c.value) === null || _c$value === void 0 ? void 0 : _c$value.id;
          }
  ...
  var resultStore = ui_vue3_pinia.defineStore('result', {
    ...
    actions: {
      ...
      changeResultProp: function changeResultProp(prop, value) {
        this[prop] = value;
      }
    }
  });
  ...
  var controlsStore = ui_vue3_pinia.defineStore('controls', {
    ...
    actions: {
      ...
      setHints: function setHints(_ref9) {
  ...
  var Application = {
    template: "\n        <router-view />\n    ",
    computed: _objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapState(dataStore, ['resultApplicationGroupId'])), ui_vue3_pinia.mapState(applicationStore, ['applicationControls'])),
    methods: _objectSpread$1(_objectSpread$1(_objectSpread$1(_objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapActions(dataStore, ['changeProp', 'runBitrixMethod'])), ui_vue3_pinia.mapActions(applicationStore, ['changeApplicationGroups', 'changeApplicationControls'])), ui_vue3_pinia.mapActions(resultStore, ['changeResultApplicationGroup', 'changeResultApplicationControls', 'setFormIdArray'])), ui_vue3_pinia.mapActions(controlsStore, ['changeControlValue'])), {}, {
      isUFParam: function isUFParam() {
        var urlSearchParams = new URLSearchParams(window.location.search);
        var result = false;
        var _iterator = _createForOfIteratorHelper(urlSearchParams.keys()),
          _step;
        try {
      ...
      setValuesToApplicationControls: function setValuesToApplicationControls() {
        var _this = this;
        var urlSearchParams = new URLSearchParams(window.location.search);
        this.applicationControls.forEach(function (c) {
    ...
    mounted: function mounted() {
      ...
      return babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee() {
        var groupsResponse, templateResponse, ufParam, _saveResponse$data, controls, saveResponse, searchResponse;
        return _regeneratorRuntime$1().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this2.changeProp('loading', true);
              _this2.changeProp('error', '');
              _context.prev = 2;
              _context.next = 5;
              return _this2.runBitrixMethod('applicationGroups');
            case 5:
              groupsResponse = _context.sent;
              _this2.changeApplicationGroups(groupsResponse.data, _this2.resultApplicationGroupId);
              _this2.changeResultApplicationGroup(groupsResponse.data, _this2.resultApplicationGroupId);
              _context.next = 10;
              return _this2.runBitrixMethod('applicationTemplate');
            case 10:
              templateResponse = _context.sent;
              _this2.changeApplicationControls(templateResponse.data, _this2.resultApplicationGroupId);
              _this2.changeResultApplicationControls(templateResponse.data, _this2.resultApplicationGroupId);
              ufParam = _this2.isUFParam();
              if (!ufParam) {
                _context.next = 28;
                break;
              }
              _this2.setValuesToApplicationControls();
              controls = _this2.applicationControls.slice();
              controls.forEach(function (c) {
              ...
              _context.next = 20;
              return _this2.runBitrixMethod('applicationSave', {
                fields: controls
              });
            case 20:
              saveResponse = _context.sent;
              _context.next = 23;
              return _this2.runBitrixMethod('searchForms', {
                applicationID: saveResponse === null || saveResponse === void 0 ? void 0 : (_saveResponse$data = saveResponse.data) === null || _saveResponse$data === void 0 ? void 0 : _saveResponse$data.applicationID
              });
            case 23:
              searchResponse = _context.sent;
              _this2.setFormIdArray(searchResponse.data);
              _this2.$router.push("/result");
              _context.next = 30;
              break;
            case 28:
            ...
            case 32:
              ...
              _this2.changeProp('loading', false);
              _this2.changeProp('error', _context.t0 !== null && _context.t0 !== void 0 && _context.t0.errors ? _context.t0.errors[0].message : _context.t0);
            case 36:
            case "end":
              return _context.stop();
          }
  ...
  var Step = {
    ...
    computed: _objectSpread$2(_objectSpread$2(_objectSpread$2({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'error', 'loading'])), ui_vue3_pinia.mapState(applicationStore, ['applicationControls', 'applicationGroups'])), {}, {
      step: function step() {
    ...
    methods: _objectSpread$2(_objectSpread$2(_objectSpread$2(_objectSpread$2(_objectSpread$2({}, ui_vue3_pinia.mapActions(dataStore, ['runBitrixMethod', 'changeProp', 'createUrl'])), ui_vue3_pinia.mapActions(applicationStore, ['changeApplicationControls', 'changeApplicationGroups'])), ui_vue3_pinia.mapActions(controlsStore, ['changeControlValue', 'runHintsAction', 'setHints'])), ui_vue3_pinia.mapActions(resultStore, ['setFormIdArray', 'setFormTemplate', 'setFormDataArray', 'changeResultApplicationGroup', 'changeResultApplicationControls'])), {}, {
      ...
      showError: function showError(response, method) {
        ...
        if (response && response.errors.length) {
          this.changeProp('error', "".concat(method ? method + ' - ' : '').concat(response.errors[0].message));
        }
      },
      send: function send() {
        var _this = this;
        ...
        var controls = JSON.parse(JSON.stringify(this.applicationControls.slice()));
        controls.forEach(function (c) {
          if (c.property === 'date' && c.type === 'range') {
            c.value = "".concat(c.value[0], "-").concat(c.value[1]);
          }
        ...
        this.runBitrixMethod('applicationSave', {
          fields: controls
        }).then(function (response) {
          var _response$data, _response$data2;
          _this.changeProp('applicationID', response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.applicationID);
          return _this.runBitrixMethod('searchForms', {
            applicationID: response === null || response === void 0 ? void 0 : (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.applicationID
          });
        }, function (r) {
    ...
    methods: {
      ...
      getProperties: function getProperties() {
        ...
        result = result.filter(function (d) {
          return d.name !== 'UF_NAME' && d.name !== 'UF_DESCRIPTION' && d.name !== 'UF_ACTIVE';
        });
      ...
      toggleMoreProperties: function toggleMoreProperties() {
        this.s = !this.s;
      }
    }
  };
    ...
    computed: {
      isDisabled: function isDisabled() {
        if (Array.isArray(this.controls)) {
          return this.controls.find(function (c) {
            return c.property !== 'checkbox' && c.required && !c.value;
          });
        }
        return true;
  ...
  var Result = {
    ...
    computed: _objectSpread$5(_objectSpread$5(_objectSpread$5(_objectSpread$5({}, ui_vue3_pinia.mapState(dataStore, ['lang', 'error', 'applicationID'])), ui_vue3_pinia.mapState(applicationStore, ['applicationControls'])), ui_vue3_pinia.mapState(resultStore, ['loading', 'formIdArray', 'formDataArray', 'groupApplicationArray', 'startIndex', 'maxCountPerRequest', 'loadingMore', 'applicationModalStateWatcher', 'resultApplicationGroup', 'resultApplicationControls', 'resultApplicationState', 'resultApplicationLoading', 'resultApplicationError', 'chosenCompanyId'])), {}, {
      showMore: function showMore() {
        return this.startIndex < this.formIdArray.length;
      }
    }),
    methods: _objectSpread$5(_objectSpread$5(_objectSpread$5(_objectSpread$5({}, ui_vue3_pinia.mapActions(dataStore, ['changeProp', 'runBitrixMethod'])), ui_vue3_pinia.mapActions(resultStore, ['setFormDataArray', 'setStartIndex', 'setMaxCountPerRequest', 'changeResultProp'])), ui_vue3_pinia.mapActions(controlsStore, ['changeControlValue', 'runHintsAction', 'setHints'])), {}, {
      createApplication: function createApplication(companyId) {
      ...
      loadNextPage: function loadNextPage() {
        ...
        try {
          var requestArr = this.formIdArray.slice(this.startIndex, this.startIndex + this.maxCountPerRequest).map(function (formID) {
            return _this.runBitrixMethod('formData', {
              code: formID
            });
          });
          Promise.all(requestArr).then(function (formDataArray) {
            ...
            _this.changeResultProp('loading', false);
            _this.changeResultProp('loadingMore', false);
            _this.setStartIndex(_this.startIndex + _this.maxCountPerRequest);
          })["catch"](function (error) {
            _this.changeResultProp('loading', false);
            if (error && error !== null && error !== void 0 && error.errors.length) {
              _this.changeProp('error', "formData - ".concat(error.errors[0].message));
            }
          });
        } catch (err) {
          throw err;
      ...
      send: function send() {
        ...
        return babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$2().mark(function _callee() {
          ...
          return _regeneratorRuntime$2().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _this2.changeResultProp('resultApplicationLoading', true);
                _context.prev = 1;
                controls = JSON.parse(JSON.stringify(_this2.resultApplicationControls));
                controls.forEach(function (c) {
                  if (c.property === 'date' && c.type === 'range') {
                    c.value = "".concat(c.value[0], "-").concat(c.value[1]);
                  }
              ...
              case 6:
                _context.next = 8;
                return _this2.runBitrixMethod('sendMessages', {
                  applicationID: _this2.applicationID,
                  questionnaires: _this2.chosenCompanyId ? [_this2.chosenCompanyId] : _this2.groupApplicationArray
                });
              case 8:
                _this2.changeResultProp('resultApplicationLoading', false);
                _this2.changeResultProp('resultApplicationState', 'success');
                _context.next = 16;
                break;
              case 12:
                _context.prev = 12;
                ...
                _this2.changeResultProp('resultApplicationLoading', false);
                _this2.changeResultProp('resultApplicationError', _context.t0 !== null && _context.t0 !== void 0 && _context.t0.errors ? _context.t0.errors[0].message : _context.t0);
              case 16:
              case "end":
                return _context.stop();
            }
