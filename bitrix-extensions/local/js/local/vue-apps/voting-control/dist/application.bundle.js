...
(function (exports,ui_vue3,local_vueComponents_loaderCircle,local_vueComponents_messageComponent,local_vueComponents_controlChoice,local_vueComponents_buttonComponent,ui_vue3_pinia) {
  ...
  var Application = {
    ...
    computed: _objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapState(dataStore, ['customData', 'signedParameters', 'actions', 'lang', 'infoBlocks', 'adminData', 'uuid', 'loading', 'error'])), ui_vue3_pinia.mapState(controlsStore, ['controls'])),
    methods: _objectSpread$1(_objectSpread$1(_objectSpread$1({}, ui_vue3_pinia.mapActions(dataStore, ['runBitrixMethod', 'changeProp'])), ui_vue3_pinia.mapActions(controlsStore, ['changeControlValue', 'changeStatus'])), {}, {
      input: function input(args) {
          ...
          return _regeneratorRuntime$1().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 1;
                _context.next = 4;
                return _this.runBitrixMethod('votingAdminData', {
                  uuid: _this.uuid
                });
              case 4:
                result = _context.sent;
                _this.changeProp('adminData', result.data);
                _this.changeStatus(result.data.statuses, result.data.selectedStatus);
          ...
          return _regeneratorRuntime$1().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.prev = 1;
                _context2.next = 4;
                return _this2.runBitrixMethod('setStatus', {
                  uuid: _this2.uuid,
                  id: String(value)
                });
              case 4:
