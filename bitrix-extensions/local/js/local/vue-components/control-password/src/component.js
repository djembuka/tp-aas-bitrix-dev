...
export const ControlPassword = {
  ...
  computed: {
    ...
    fillColor() {
      return this.invalid ? '#ff0000' : '#5F7696';
    },
  },
  watch: {
    validateWatcher() {
